...
public class PatientController {
        ...
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        ...
        @PreAuthorize("hasAnyRole('ROLE_SU','ROLE_AU','ROLE_NU')")
        @Operation(summary = "get Patient medicine")
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        ...
        @PreAuthorize("hasAnyRole('ROLE_SU','ROLE_AU','ROLE_NU')")
        @Operation(summary = "get Patient history")
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        ...
        @PreAuthorize("hasAnyRole('ROLE_SU','ROLE_AU','ROLE_NU')")
        @Operation(summary = "get Patient all medicine")
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        ...
        @PreAuthorize("hasAnyRole('ROLE_SU','ROLE_AU','ROLE_NU')")
        @Operation(summary = "add Patient medicine")
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        ...
        @ApiResponse(responseCode = "200", description = "Http status 200 Create")
        public ResponseEntity<Object> deactivatePatient(@PathVariable(name = "id") Long id) {
        ...
        public ResponseEntity<BasisResponse> deleteMedicineOfSpecializationPatient(
                ...
                return ResponseEntity
                                .ok(patientMedicineService.deleteMedicineBySpecialization(patientId, specializationId));
        }
