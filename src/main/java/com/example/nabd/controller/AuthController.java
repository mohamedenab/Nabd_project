...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtAuthnResponse> loginFun(@RequestBody LoginDto loginDto){
    ...
    public ResponseEntity<JwtAuthnResponse> registerFun(@RequestBody RegisterDto registerDto){
